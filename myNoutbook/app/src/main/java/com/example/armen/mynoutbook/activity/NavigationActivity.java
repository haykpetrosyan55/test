    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.home:
                ...
                break;
            case R.id.msi:
                productFragment.upDaListData("MSI");
                break;
            case R.id.acer:
                productFragment.upDaListData("Predator");
                break;
            case R.id.asus:
                productFragment.upDaListData("rog");
                break;
            case R.id.gigabyte:
                productFragment.upDaListData("gig");
                break;
            case R.id.apple:
                productFragment.upDaListData("apple");
                break;
            case R.id.razer_blade:
                productFragment.upDaListData("razer");
                break;
